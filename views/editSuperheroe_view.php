            ...
            <div class="container py-5 h-100">
                ...
                <div class="col-lg-8 col-xl-6">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Editar</h3>
                        ...
                        <form class="px-md-2" method="post" action="">
                            ...
                            <div class="form-outline mb-4">
                                <label class="form-label" for="form3Example1q">Evolucion</label>
                                <input type="text" name="evolucion" id="evolucion" class="form-control" value="<?php echo $data['evolucion']?>"/>
                                <span class="form-text text-muted"><?php echo $data['msgErrorEvolucion']?></span>
                            </div>

                            <button type="submit" class="btn btn-success btn-lg mb-1">Modificar Heroe</button>
